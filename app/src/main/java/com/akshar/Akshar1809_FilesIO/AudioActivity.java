...
import com.akshar.Akshar1809_FilesIO.R;
...
public class AudioActivity extends AppCompatActivity {
    ...
    private AudioRecyclerViewAdapter recyclerViewAdapter;
    private Uri fileUri;
...
//        recyclerView.setNestedScrollingEnabled(false);
        ...
        recyclerViewAdapter = new AudioRecyclerViewAdapter(this);
...
//        super.onStop();
//        recyclerViewAdapter.mPlayer.stop();
//        recyclerViewAdapter.mPlayer.reset();
//    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        if (recyclerViewAdapter.yes_no==true) {
            recyclerViewAdapter.mPlayer.stop();
            recyclerViewAdapter.mPlayer.release();
        }
